...
import { makeVariationSan } from '../src/san';
...
test('variation with king move', () => {
  ...
  expect(makeVariationSan(pos, variation)).toBe('1. e4 e5 2. Ke2');
...
test('crazyhouse variation', () => {
  ...
  expect(makeVariationSan(pos, variation)).toBe('36... N@a3+ 37. Kb2 R@b1#');
